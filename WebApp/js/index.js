...
$(document).ready(function() {
  ...
  function initMap($card) {
    ...
    var latLngFrom = {lat: 43.6597309, lng: -79.3996037};
    var latLngTo = {lat: 43.6587234, lng: -79.3979459};
    var latLngCenter = {
...
app.controller("DelivCtrl", ['$scope','$http', function($scope, $http) {
  $http.get("http://localhost:8000/api/v1/washrooms/").success(function(data){
    console.log(data["washrooms"])
    $scope.cards = data["washrooms"]
  })
